...
/**
 * Servlet implementation class SearchUserChat
 */
@WebServlet("/searchuserchat")
public class SearchUserChat extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			if(auth == null) {
	 	 	...
	 	 	String search = req.getParameter("searchTerm");
	 	 	...
	 	 	ArrayList<Userbean> listUser = userbo.searchUser(search);
	 	 	if(listUser.size() == 0) {
	 	 		out.println("Không tìm thấy người dùng phù hợp");
	 	 	}
	 	 	else {
